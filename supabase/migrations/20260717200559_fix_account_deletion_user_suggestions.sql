-- The production suggestions table is keyed by user_email rather than user_id.
-- Resolve the Auth email before deleting the profile so account erasure remains
-- atomic and includes suggestions without referencing a nonexistent column.
