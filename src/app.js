...
(function () {
    ...
    const WHATS_NEW = [
        { tag: 'Fix', date: 'Jul 12', title: 'You flagged it, we fixed it', desc: 'Thanks to the members who tapped Report. After your feedback we reviewed all 1,500+ questions and corrected 17 — a few clunky scenarios, some clinical-detail wording, and one answer key — so every question reads exactly right. Spot something off in a question? Tap Report on it; we read every single one, and it makes the bank sharper for everyone.' },
